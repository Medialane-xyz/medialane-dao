...
const features = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'ERC-1155 Edition',   status: 'Live',   href: 'https://medialane.io/launchpad',
        description: 'Multi-copy editions for music, publications, and prints. One contract, multiple token IDs and quantities. Partial listing support — sell 5 of your 100 edition copies at once.',
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Protocol v2',        status: 'Audited', href: `https://starkscan.co/contract/${starknet.marketplace721}`,
