  ...
  return (
    <div className="px-4 sm:px-6 lg:px-10 xl:px-14 py-10 sm:py-12 lg:py-16 space-y-12">
      ...
      <PageHero
        ...
        title="MDLN Token"
        description="21 million fixed supply. 100% DAO treasury. No VCs, no insiders, no preferential allocation. Governance is earned, not bought. Revenue generated by the protocol flows to the community treasury — MDLN holders vote annually on how it is used."
      />
