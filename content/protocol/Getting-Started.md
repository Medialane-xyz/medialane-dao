...
description: "Create your first IP asset on Medialane in minutes — no gas required, no registration fee, no intermediaries."
date: "2026-05-01"
...
Navigate to [medialane.io](https://medialane.io). Connect your wallet or log in with email. First-time users are walked through wallet creation automatically.
...
| Action | Fee |
|--------|-----|
| Mint IP asset | Free (gas sponsored) |
...
| Chain | Purpose |
|-------|---------|
| **Starknet Mainnet** | All IP assets, marketplace, collections, launchpad |
...
| Wallet | Type | Notes |
|--------|------|-------|
| **Argent X** | Browser extension | Full Starknet support, recommended for power users |
| **Braavos** | Browser extension | Full Starknet support |
| **Privy (email/social)** | Custodial | No seed phrase, best for onboarding new creators |
