...
Welcome to Medialane, a decentralized protocol for creators and communities. These guidelines are designed to foster a respectful, inclusive, and collaborative environment for all participants.
...
* **Public Good Orientation:** Medialane is a protocol for collective benefit, not private gain.
...
Medialane welcomes contributions across multiple domains:
...
* Follow Medialane’s documentation and licensing protocols.
...
While Medialane is permissionless, community spaces may be moderated to:
