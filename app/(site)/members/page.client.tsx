    ...
    <div className="px-6 lg:px-10 xl:px-14 py-8 space-y-10">
      ...
      <div>
        ...
        <p className="text-base text-muted-foreground max-w-xl">
          21 million fixed supply. 100% DAO treasury. No VCs, no insiders, no preferential allocation.
          Governance is earned, not bought. Revenue generated by the protocol flows back to the community through the Creator's Airdrop.
        </p>
      </div>
